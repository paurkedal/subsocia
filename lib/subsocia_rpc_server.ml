...
module Utils (C : Subsocia_intf.S) = struct
  let rec decode_eap = function
    ...
    | Eap_present e_id ->
      let%lwt C.Attribute_type.Ex at = C.Attribute_type.of_id e_id in
...
module Server_impl = struct
  ...
  module Entity_type = struct
    ...
    let entity_name_tmpl (module C : Subsocia_intf.S) et =
      let%lwt et = C.Entity_type.of_id et in
    ...
    let can_dsub (module C : Subsocia_intf.S) et0 et1 =
      ...
      let%lwt et1 = C.Entity_type.of_id et1 in
  ...
  module Entity = struct
    let create (module C : Subsocia_intf.S) entity_type =
      let%lwt entity_type = C.Entity_type.of_id entity_type in
      C.Entity.create entity_type >|=
      C.Entity.id
    ...
    let type_members (module C : Subsocia_intf.S) et_id =
      let%lwt et = C.Entity_type.of_id et_id in
    ...
    let dsub (module C : Subsocia_intf.S) et_id e_id =
      let%lwt et = Pwt_option.map_s C.Entity_type.of_id et_id in
